...
1. Asignar las variables de entorno mencionadas más adelante.
...
4. Correr el comando py app.py (o su equivalente en otros sistemas operativos) e ingresar
al url en un browser.
...
* Asumimos que la tabla de posiciones de la fase de grupos de la página torneo es general y no por grupo.
